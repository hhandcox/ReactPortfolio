        ...
        <section className="pt-4 aboutTechCard" id="techCards">
            ...
            <div className="row">
                <div className="col-lg-6 col-xl-4 mb-5">
                    <div className="card infoCard border-0 h-100">
                        <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <div className="feature mb-4 mt-n4"><i className="fa-brands fa-bootstrap round-icon"></i></div>
                ...
                <div className="col-lg-6 col-xl-4 mb-5">
                    <div className="card infoCard border-0 h-100">
                        <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <div className="feature mb-4 mt-n4"><i className="fa-solid fa-code round-icon"></i></div>
                ...
                <div className="col-lg-6 col-xl-4 mb-5">
                    <div className="card infoCard border-0 h-100">
                        <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <div className="feature mb-4 mt-n4"><i className="fa-brands fa-react round-icon"></i></div>
                ...
                <div className="col-lg-6 col-xl-4 mb-5">
                    <div className="card infoCard border-0 h-100">
                        <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <div className="feature mb-4 rounded-3 mt-n4"><i className="fa-brands fa-node-js round-icon"></i></div>
                ...
                <div className="col-lg-6 col-xl-4 mb-5">
                    <div className="card infoCard border-0 h-100">
                        <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <div className="feature rounded-3 mb-4 mt-n4"><i className="fa-brands fa-mdb round-icon"></i></div>
                ...
                <div className="col-lg-6 col-xl-4 mb-5">
                    <div className="card infoCard border-0 h-100">
                        <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                            <div className="feature rounded-3 mb-4 mt-n4"><i className="fa-brands fa-python round-icon"></i></div>
